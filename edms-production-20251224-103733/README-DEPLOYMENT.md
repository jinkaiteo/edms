...
**Package**: edms-production-20251224-103733  
**Created**: Wed Dec 24 10:37:33 AM +08 2025  
**Version**: 2.0
...
1. **Copy package to production server**
   ```bash
   scp -r edms-production-20251224-103733 user@server:/opt/
   ```

2. **SSH to server and navigate to package**
   ```bash
   ssh user@server
   cd /opt/edms-production-20251224-103733
   ```
