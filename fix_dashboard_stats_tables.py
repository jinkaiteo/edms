"""
Fix dashboard_stats.py to use correct table names based on actual Django models.
This script will be run on the staging server to update the dashboard stats API.
"""
...
Updated to use correct table names from Django models.
"""
...
class DashboardStatsView(APIView):
    ...
    def _generate_activity_title(self, action, object_representation):
        ...
        action_titles = {
            ...
            'DOCUMENT_CREATED': f"Document Created: {object_representation or 'Unknown'}",
            'USER_LOGIN': f"User Login: {object_representation or 'Unknown'}",
        }
