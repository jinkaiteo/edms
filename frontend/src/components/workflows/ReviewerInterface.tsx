      ...
      <div className="flex items-center justify-center min-h-screen p-4">
        <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-screen overflow-y-auto">
          ...
          <div className="px-6 py-4 border-t border-gray-200">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">📥 Document Downloads</h3>
            <p className="text-sm text-gray-600 mb-4">
              Choose download type per EDMS specification (lines 50-68):
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              >
                <div className="flex items-center mb-2">
                  ...
                  <span className="font-semibold">Annotated Document</span>
                </div>
                <p className="text-xs text-gray-500">
                  Document with metadata placeholders filled
                </p>
              </button>
              ...
              >
                <div className="flex items-center mb-2">
                  ...
                  <span className="font-semibold">Official PDF</span>
                </div>
                <p className="text-xs text-gray-500">
                  Digitally signed PDF (available after approval)
                </p>
              </button>
            </div>
          </div>
