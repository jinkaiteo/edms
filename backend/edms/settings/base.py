...
# This is the local timezone shown alongside UTC in documents
...
# The 'static' directory is not needed as Django admin has its own static files
STATICFILES_DIRS = []
...
# CELERY_RESULT_BACKEND configured below (line 360) - DO NOT set here to avoid conflicts
CELERY_TIMEZONE = 'UTC'
