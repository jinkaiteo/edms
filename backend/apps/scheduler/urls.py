...
from .monitoring_dashboard import manual_trigger_api, scheduler_dashboard
from .task_monitor import task_status_api
...
urlpatterns = [
    ...
    path('admin/status/', task_status_api, name='scheduler_admin_status'),
