    ...
    def transition_workflow(self, workflow_instance: WorkflowInstance, 
        ...
        try:
            with transaction.atomic():
                ...
                # Execute River transition
                workflow_object = InstanceWorkflowObject(workflow_instance)
                transition = workflow_object.get_available_transition(transition_name)
                ...
                # Execute transition
                workflow_object.proceed(user, transition_name)
                
                # Update workflow instance
                new_state = workflow_instance.state
