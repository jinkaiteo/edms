...
# WorkflowTask model removed - replaced with document filtering approach
# Tasks are now represented by document status and user assignments
# Users see "documents requiring action" instead of separate task records
...
# Import simple workflow models (EDMS-compliant approach)
from .models_simple import DocumentState, DocumentWorkflow, DocumentTransition
