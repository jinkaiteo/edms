...
class UserSession(models.Model):
    """
    Track user sessions for compliance and audit purposes.
    
    Maintains session information beyond Django's standard
    session framework for regulatory requirements.
    """
