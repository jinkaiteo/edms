...
# Backup app has been removed - backup tasks are no longer used
# Method #2 backup system uses shell scripts instead of Celery tasks
...
app.conf.beat_schedule = {
    ...
    # S4 Backup System - Removed (replaced with Method #2 using shell scripts and cron)
    # Backup schedules are now configured in scripts/setup-backup-cron.sh
}
...
app.conf.task_routes = {
    ...
    # 'apps.backup.tasks.*': {'queue': 'maintenance'},  # Backup app removed
